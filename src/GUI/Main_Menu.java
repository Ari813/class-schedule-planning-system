...
public class Main_Menu extends JPanel {
	...
	public Main_Menu()  {
		...
		PNL_Main.add(btnLecturerPreferences);
		...
		PNL_Main.add(lblDatabaseManagment);
		...
		PNL_Main.add(lblSemesterManagment);
