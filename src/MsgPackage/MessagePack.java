...
public class MessagePack implements Serializable {
	...
	public enum OpType {
		...
		Login, Logout, GetClassAids, GetCampusInfo, GetBuildingsInfo, GetStudyAidsInfo, GetAllClasses, GetAllCourses, GetFacultyInfo, GetLecturersInfo, NewClass, UpadteClass,
	};
